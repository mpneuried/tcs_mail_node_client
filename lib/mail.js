(function() {
  ...
  module.exports = Mail = (function(_super) {
    ...
    Mail.prototype._validateAndConvertAttributes = function(attrs, cb) {
      ...
      } else if ((factoryConf.charsetSubject != null) && factoryConf.charsetSubject !== "UTF-8") {
        serviceData.email.SubjectCharset = factoryConf.charsetSubject;
      } else if (factoryConf.charset !== "UTF-8") {
      ...
      if (attrs.text != null) {
        ...
        } else if ((factoryConf.charsetText != null) && factoryConf.charsetText !== "UTF-8") {
      ...
      if (attrs.html != null) {
        ...
        } else if ((factoryConf.charsetHtml != null) && factoryConf.charsetHtml !== "UTF-8") {
