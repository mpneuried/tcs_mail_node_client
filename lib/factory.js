  ...
  module.exports = MailFactory = (function(_super) {
    ...
    MailFactory.prototype._send = function(mailData, callback) {
      ...
      if (this._cnf.simulate) {
        _.delay(function() {
          var _recipients, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _sout;
          ...
          if ((_ref3 = reqOpt.json.email) != null ? (_ref4 = _ref3.Text) != null ? _ref4.length : void 0 : void 0) {
            _sout += "--- BODY: text -----------------------------\n" + reqOpt.json.email.Text + "\n";
          }
          if ((_ref5 = reqOpt.json.email) != null ? (_ref6 = _ref5.Html) != null ? _ref6.length : void 0 : void 0) {
